...
const defaultTopProperties = [
  { page: "Exam Stress", visitors: 245 },
  { page: "Social Anxiety", visitors: 189 },
  { page: "Homesickness", visitors: 156 },
  { page: "Career Pressure", visitors: 98 },
]
    ...
    >
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h3 className="text-lg font-semibold text-slate-900">Community Activity</h3>
      ...
      <div className="mb-6">
        <p className="mb-3 text-sm font-medium text-slate-700">Support Sessions</p>
        <div className="h-32">
      ...
      <div>
        <p className="mb-3 text-sm font-medium text-slate-700">Trending Topics</p>
