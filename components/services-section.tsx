...
const services = [
  {
    icon: Users,
    title: "Peer Matching",
    description: "Find someone who shares your experiences and background.",
  },
  {
    icon: MessageCircle,
    title: "Safe Communication",
    description: "Chat anonymously or schedule video calls on your terms.",
  },
  {
    icon: Shield,
    title: "Verified & Secure",
    description: "Every peer counselor is verified and trained. Your data is protected.",
  },
]
    ...
    <section id="how-it-works" className="py-32 px-6 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div ref={sectionRef} className="relative px-6 lg:px-8 py-16 lg:py-10 mb-32 overflow-hidden rounded-3xl">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-1 lg:order-2">
              <p className="text-sm uppercase tracking-[0.2em] text-white/80 font-medium mb-4">Breaking the stigma</p>
              ...
              <div className="space-y-6 text-white/90 leading-relaxed">
                <p>
                  At ASU4U, we believe support should be accessible to everyone. Our platform connects students directly with peer counselors who understand their unique challenges.
                </p>
                <p>
                  Every match is curated, every conversation confidential. We've reimagined the support experience to make it safe, instant, and human.
                </p>
              </div>
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-normal mb-6 text-balance font-serif">Everything you need to thrive</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            A complete platform to manage your mental well-being, whether you're seeking support or offering it.
          </p>
        </div>
