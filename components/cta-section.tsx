      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-10">
            Join thousands of students who are supporting each other through their university journey.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="relative flex items-center justify-center gap-0 bg-foreground text-background rounded-full pl-6 pr-1.5 py-1.5 transition-all duration-300 group overflow-hidden">
              <span className="text-sm pr-4">Get Matched</span>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-16">
          ...
          <div className="text-center">
            <p className="text-7xl font-light text-foreground">5K+</p>
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Peer Counselors</p>
          </div>
          <div className="text-center">
