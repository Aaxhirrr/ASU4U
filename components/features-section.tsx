...
const allTransactions = [
  { name: "Engineering Support", amount: "Connected", category: "Match Found", color: "from-emerald-400 to-teal-500" },
  { name: "First-Gen Chat", amount: "Active", category: "Session", color: "from-blue-400 to-indigo-500" },
  { name: "Anxiety Group", amount: "Joined", category: "Community", color: "from-amber-400 to-orange-500" },
  { name: "Study Stress", amount: "Connected", category: "Match Found", color: "from-rose-400 to-pink-500" },
  { name: "New Student", amount: "Active", category: "Session", color: "from-violet-400 to-purple-500" },
  { name: "LGBTQ+ Ally", amount: "Joined", category: "Community", color: "from-cyan-400 to-blue-500" },
  { name: "Exam Presure", amount: "Connected", category: "Match Found", color: "from-lime-400 to-green-500" },
  { name: "Social Activity", amount: "Active", category: "Event", color: "from-fuchsia-400 to-pink-500" },
]
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Track your mood, schedule sessions, and connect with peers from a single intuitive and confidential
                interface.
              </p>
            </motion.div>
